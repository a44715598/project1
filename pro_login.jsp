    ...
    <div class="form_design1">
      <form class="form-horizontal" action="lay_login.jsp" method="POST">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="username" style="background-color: transparent" class="form-control" id="inputEmail3" placeholder="username">
          </div>
        </div>
        <div class="form-group">
          <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
          <div class="col-sm-10">
            <input type="password" name="password" style="background-color: transparent" class="form-control" id="inputPassword3" placeholder="password">
          </div>
        </div>
        <div class="form-group">
    ...
    <div class="modal-content" style="background-color: transparent;">
      ...
      <form class="form-horizontal" action="lay_signup.jsp" method="POST">
        <div class="modal-body">
          <div class="row">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" id="inputNmae" placeholder="用户名:4-20位英文字母/数字"  name="username_sign">
              </div>
            </div>
            <div class="form-group">
              <label for="inputSex" class="col-sm-3 control-label">password</label>
              <div class="col-sm-9">
                <input type="password" class="form-control" id="inputSex" placeholder="密码:不能为空" name="password_sign">
              </div>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          ...
          <button type="reset" class="btn btn-warning">Emptied</button>
        </div>
      </form>
    </div>
  </div>
