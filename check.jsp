...
<sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver"
    ...
    <%
        ...
        ccccc.add(Calendar.DAY_OF_MONTH,30);
    %>
<sql:update dataSource="${snapshot}" var="result2">
        INSERT INTO proposal(Title,Content,WriterId,Deadline,Status,Agree,Disagree,IsPro) VALUES ('<%=title%>','<%=Content%>','<%=userid%>','<%=(new java.sql.Date(ccccc.getTime().getTime()).toString())%>','1',0,0,'T');
    </sql:update>
