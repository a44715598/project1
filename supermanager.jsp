        ...
        <div class="col-md-9">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="detail3.jsp?id=<%=p.getId()%>">详情</a>
                                <a href="delete4.jsp?id=<%=p.getId()%>">删除</a>
                                <%--<% out.print( p.getId() ); %>--%>
                                <!--< a href="">修改</ a>-->
                                <!--< a href="">删除</ a>-->
                            </td>
            ...
            <div>
                <ul class="pagination pull-right">
                    <li>
                        <a href="supermanager.jsp?page=<%=indexB%>" aria-label="Previous">
...
%>
                    <li>
                        ...
                        %>
                        <a href="supermanager.jsp?page=<%=i%>"><% out.print( i ); %></a>
                    </li>
                    <%
                        }
                    %>
                    <li>
                        <a href="supermanager.jsp?page=<%=indexF%>" aria-label="Next">
