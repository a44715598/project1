...
<%
    ...
    ArrayList<Proposal> pList = con.getProposalByUId( userid );
        ...
        <div class="col-md-9">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="delete2.jsp?id=<%=p.getId()%>">撤销</a>
                                <a href="standardedit.jsp?id=<%=p.getId()%>">规范</a>
                                <%--<% out.print( p.getId() ); %>--%>
                                <!--< a href="">修改</ a>-->
                                <!--< a href="">删除</ a>-->
                            </td>
            ...
            <div>
                <ul class="pagination pull-right">
                    <li>
                        <a href="personal.jsp?page=<%=indexB%>" aria-label="Previous">
...
%>
                    <li>
                        ...
                        %>
                        <a href="personal.jsp?page=<%=i%>"><% out.print( i ); %></a>
                    </li>
                    <%
                        }
                    %>
                    <li>
                        <a href="personal.jsp?page=<%=indexF%>" aria-label="Next">
