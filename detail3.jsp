    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                <a href="supermanager.jsp" class="list-group-item active">题案管理</a>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="jumbotron">
                        ...
                        <form class="form-horizontal" action="detail3.jsp" method="get">
                        ...
                        <tr>
                            ...
                            <c:forEach var="row" items="${result6.rows}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="detail4.jsp?id=${row.FileId}">详情</a>
                                        <!--<a href="">修改</a>-->
                                        <!--<a href="">删除</a>-->
                                    </td>
                                </tr>
